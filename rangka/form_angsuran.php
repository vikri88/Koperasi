<div class="register" id="angsuranbox" style="display: none;">
	<form class="register-modal-content animate" enctype="multipart/form-data" action="fungsi/angsuran.php" method="post">
